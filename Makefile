...
arduino:
	...
	avr-gcc -Os -mmcu=atmega328p -c serial.c -o build/serial.o
	avr-gcc -Os -mmcu=atmega328p -c processor.c -o build/processor.o
	avr-gcc -Os -mmcu=atmega328p -c main.c -DPROGRAM=\""$(PROGRAM)"\" -DPROGRAM_SIZE=$(PROGRAM_SIZE) -o build/main.o 
	avr-gcc -Os -mmcu=atmega328p build/ALU.o build/memory.o build/stack.o build/delay.o build/io.o build/serial.o build/processor.o build/main.o -o build/main.bin
